      ...
      <Section>
        <Container>
          <div className="grid gap-8">
            {codigoPage.secoes.map((secao, index) => (
              <motion.article
                key={secao.titulo}
      ...
      <Section>
        <Container>
          ...
          >
            ...
            <h2 className="font-arcane text-4xl md:text-6xl text-[var(--rito-ivory)]">
              {codigoLadoSombrio.titulo}
            </h2>

            <Divider />

            <p className="mb-8 text-base leading-8 text-[var(--rito-muted)]">
              {codigoLadoSombrio.descricao}
            </p>

            <div className="grid gap-4 md:grid-cols-2">
              {codigoLadoSombrio.riscos.map((item) => (
                <div
                  key={item}
                  className="rounded-2xl border border-orange-900/40 bg-orange-950/10 p-5"
                >
      ...
      <Section>
        <Container>
          ...
          >
            ...
            <div className="space-y-5 text-base leading-8 text-[var(--rito-muted)]">
              {codigoPapel.texto.map((paragrafo) => (
                <p key={paragrafo}>{paragrafo}</p>
              ))}
            </div>
          </motion.article>
