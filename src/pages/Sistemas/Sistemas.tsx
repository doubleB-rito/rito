...
import { sistemas, sistemasPage } from "../../data/sistemas";
        ...
        <Container>
          ...
          >
            ...
            <div className="space-y-5 text-base leading-8 text-[var(--rito-muted)]">
              {sistemasPage.introducao.map((paragrafo) => (
